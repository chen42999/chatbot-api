...
public class ZsxqApi implements IZxsqApi {
    ...
    public UnAnswerQuestionAggregates queryUnAnswerQuestionTopicId(String groupId, String cookie) throws IOException {
        ...
        if (response.getStatusLine().getStatusCode() == HttpStatus.SC_OK) {
            ...
            return JSON.parseObject(jsonStr, UnAnswerQuestionAggregates.class);
        } else {
            throw new RuntimeException("queryUnAnswerQuestionTopicId Error Code is " + response.getStatusLine().getStatusCode());
        }
    }

    @Override
    public boolean answer(String groupId, String cookie, String topicId, String text, boolean silence) throws IOException {
        ...
        post.addHeader("user-agent", "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/106.0.0.0 Safari/537.36");
...
//                "}";
        ...
        AnswerReq answerReq = new AnswerReq(new ReqData(text, silence));
